...
cat("\n=== exp1: Precision (mean over widths of cell SD / W) ===\n")
print(summary_tbl)
...
write.csv(summary_tbl, "exp1/outputs/tables/precision_summary.csv", row.names = FALSE)
write.csv(results, "exp1/outputs/tables/precision_tests.csv", row.names = FALSE)
